...
### 1. ?? Backup Data Belum Berkala (*High Risk*)
...
### 2. ?? Fitur *Generate Report* Tidak Berfungsi (*High Risk*)
...
### 3. ?? Kestabilan Website saat Transaksi Berulang (*High Risk*)
...
### 4. ?? Dashboard Summary Tidak Menampilkan Data Aktual (*Moderate Risk*)
...
### 5. ?? Tampilan Antarmuka (UI/UX) Belum Optimal (*Moderate Risk*)
...
- **Rekomendasi:** Perbaiki styling CSS/responsiveness banner & logo navbar, serta lengkapi profil profil bisnis pada halaman *About Us*.

### 6. ?? Link Contact Us Menghasilkan Error 404 (*Moderate Risk*)
